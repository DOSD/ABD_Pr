<?php
  ...
  if(!isset($_SESSION['CurrentUser'])){
    ...
    if(isset($_POST["mensaje"])){  
        ...
        $currentPartener=$_GET['currentPartener'];
        $currentUser=$_SESSION['CurrentUser'];
        
        $consulta="SELECT * FROM mensaje";$nummensajes=mysqli_num_rows( mysqli_query($db, $consulta)) ;
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Melomanía<small>  Chat Privado</small>
                        </h1>
                    </div>
                </div>
        ...
        <div class="col-xs-12 col-md-offset-2 col-md-8 col-lg-8 col-lg-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="glyphicon glyphicon-comment"></span> Chat con <?php echo $_GET['currentPartener'];?>
                </div>
                    	...
                    	<?php 
                    		...
                    		$currentPartener=$_GET['currentPartener'];
       						...
       						while($listaMensajes =  mysqli_fetch_object($consulta)){
                    			if($listaMensajes->Emisor == $currentPartener && $listaMensajes->Receptor == $currentUser){
                    			...
                    			else if($listaMensajes->Emisor == $currentUser && $listaMensajes->Receptor == $currentPartener){
                    		...
                    		if($nomensajes){
                    			echo "<h2 class='text-center'><small>Aún no tienes mensajes con este usuario</small><h2>";
                    		}
                    		mysqli_close($db);
                    	?>
                ...
                <div class="panel-footer clearfix">
                    <?php
                         $currentPartener=$_GET['currentPartener'];
                        echo  "<form action='privatechat.php?currentPartener=" .$currentPartener. "' method='post'>";
                    ?>
