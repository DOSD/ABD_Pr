<?php
  ...
  if(!isset($_SESSION['CurrentUser'])){
    ...
    if(isset($_POST["mensaje"])){  
        ...
        $sql = "INSERT INTO mensaje VALUES ('$currentUser','none','$currentGroup',NOW(),'$mensaje','')";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Melomanía<small>  Chat Grupal</small>
                        </h1>
                    </div>
                </div>
        ...
        <div class="col-xs-12 col-md-offset-2 col-md-8 col-lg-8 col-lg-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="glyphicon glyphicon-comment"></span> Chat de grupo <?php echo $_GET['currentGroup'];?>
                </div>
                    	...
                    	<?php 
                            ...
                            $nomensajes=true;
       						...
       						while($listaMensajes =  mysqli_fetch_object($consulta)){
                    			if($listaMensajes->Emisor != $currentUser && $listaMensajes->GrupoReceptor == $currentGroup){
                                            ...
                                            <img src="img/usermessage.png" alt="User Avatar" class="img-circle user-icon" /></span>
                                                <div class="chat-body clearfix">
                                                    <div class="header">
                                                        ...
                                                        <p>' .$listaMensajes->Texto. '</p>
                                                </div>
                                         </li>
                                         <br>';
                                    $nomensajes=false;
                    			}
                    			else if($listaMensajes->Emisor == $currentUser && $listaMensajes->GrupoReceptor == $currentGroup){
                ...
                <div class="panel-footer clearfix">
                    <?php
                         $currentGroup=$_GET['currentGroup'];
                        echo  "<form action='groupchat.php?currentGroup=" .$currentGroup. "' method='post'>";
                    ?>
